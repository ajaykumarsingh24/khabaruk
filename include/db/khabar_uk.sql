...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 02, 2024 at 03:52 PM
...
CREATE TABLE `users` (
  ...
  `last_success_login_ip` varchar(35) NOT NULL,
  `last_failed_login_ip` varchar(35) NOT NULL,
  `role_id` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `account_status` enum('0','1') NOT NULL DEFAULT '0'
